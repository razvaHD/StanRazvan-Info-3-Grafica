...
glm::vec3 terminalvelocity=glm::vec3(0.0f, 20.0f, 0.0f);
...
int main()
{
    ...
    unsigned int texture1 = loadTexture("assets/images/container2edt.png");
    unsigned int map = loadTexture("assets/images/container2_specular.png");
    lightingShader.use();
    ...
    for(i=0;i<sizes[0];++i)
    {
        ...
        {   
            for(k=0;k<sizes[2];++k)
            {
                ...
                blocks[i*sizes[1]*sizes[2]+j*sizes[2]+k]=glm::vec3((float)i,(float)j-20,(float)k);
            }
        }
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for(i=0;i<sizes[0];++i)
        {
            for(j=0;j<sizes[1];++j)
            {
                ...
                {
                    model = glm::mat4(1.0f);
                    model = glm::translate(model, blocks[i*sizes[1]*sizes[2]+j*sizes[2]+k]);
